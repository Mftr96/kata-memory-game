...
cards.forEach((card, index) => {
    ...
    card.onclick = helper.debounce(() => {
        ...
        if (showedCards.length === 2) {
            ...
            //TO-DO: creare alert a partita finita 
            // if(cards.every(card => card.children[0].src == "../assets/images/back.png")){
            //     alert("Hai vinto! Ricarica la pagina per giocare un 'altra emozionante partita!");
            // }
        }
    })
